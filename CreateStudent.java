...
public class CreateNote extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://180.76.141.177/linux_final";
   final static String USER = "root";
   final static String PASS = "Ssy011016!";
   final static String SQL_INSERT_STUDENT = "INSERT INTO t_student(student_id,student_age, student_time) ";
   ...
   private int createStudent(Student req) {
      ...
      try {
         ...
         stmt.setString(1, req.studentname);
         stmt.setString(2, req.studentage);
